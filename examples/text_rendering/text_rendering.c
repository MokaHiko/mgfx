...
void mgfx_example_update() {
  ...
  mgfx_debug_draw_text(position.x, position.y, "apple");
  mgfx_debug_draw_text(position.x, position.y + 32, "orange");
  mgfx_debug_draw_text(position.x, position.y + 64, "banana");
  mgfx_debug_draw_text(position.x, position.y + 96, "mango");
  mgfx_debug_draw_text(position.x, position.y + 128, "guava");
}
