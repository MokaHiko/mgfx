...
void mgfx_example_init() {
    ...
    // Mesh pass
    uint32_t pixel_factor = 6;
    struct mgfx_image_info color_attachment_info = {
        .format = VK_FORMAT_R16G16B16A16_SFLOAT,
        .width = APP_WIDTH / pixel_factor,
        .height = APP_HEIGHT / pixel_factor ,
        .layers = 1,
    };
    ...
    sponza.vl = &vl;
    /*LOAD_GLTF_MODEL("Lantern", gltf_loader_flag_default, &sponza);*/
    load_scene_from_path("/Users/christianmarkg.solon/Downloads/tree/tree.gltf", gltf_loader_flag_default, &sponza);
    ...
    color_fba_texture = mgfx_texture_create_from_image(mesh_pass_color_attachment, VK_FILTER_NEAREST);
